...
const TeacherList: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await addTeacher(newTeacher, sendInvite);
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Manage your faculty and staff</p>
        </div>
        <button
          onClick={() => setShowAddModal(true)}
          className="flex items-center space-x-2 bg-purple-600 hover:bg-purple-500 text-white px-6 py-3 rounded-2xl shadow-lg shadow-purple-500/20 transition-all active:scale-95"
        >
          <Plus size={20} />
        ...
        <div className="p-6 border-b border-slate-200 dark:border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/50 dark:bg-slate-900/50">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full bg-slate-100 dark:bg-slate-800 border-none rounded-xl py-2 pl-10 pr-4 text-sm focus:ring-2 focus:ring-purple-500 outline-none"
            />
          </div>
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
              {teachers.length === 0 ? (
                <tr>
                  ...
                  >
                    No teachers found. Click "Add Teacher" to add your first
                    faculty member.
                  </td>
                </tr>
              ) : (
                teachers.map((teacher) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span className="bg-purple-100/50 dark:bg-purple-900/30 px-3 py-1 rounded-full text-xs font-bold text-purple-600 dark:text-purple-400">
                        {teacher.subject}
                      </span>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end space-x-2">
                        ...
                        <button className="p-1.5 text-slate-400 hover:text-purple-500 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-lg transition-all">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-100 dark:bg-slate-800 border-none rounded-xl py-3 px-4 text-slate-900 dark:text-white focus:ring-2 focus:ring-purple-500 transition-all outline-none"
              ...
              <div className="flex items-center space-x-2 py-2">
                <input
                  ...
                  id="sendInvite"
                  defaultChecked
                  className="w-4 h-4 rounded text-purple-600 focus:ring-purple-500 bg-slate-100 dark:bg-slate-800 border-none"
                />
                <label
                  htmlFor="sendInvite"
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={isSaving}
                  className="flex-1 bg-purple-600 text-white font-bold py-3 rounded-xl shadow-lg shadow-purple-600/20 hover:bg-purple-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
